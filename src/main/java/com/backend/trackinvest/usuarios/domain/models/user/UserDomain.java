...
public class UserDomain {
    ...
    private UserDomain(UUID id, String cognitoId, String fullname, String email, LocalDateTime createdAt, LocalDateTime updatedAt, List<WalletDomain> wallets) {
    ...
    public static UserDomain create(UUID id, String cognitoId, String fullname, String email, List<WalletDomain> wallets) {
        LocalDateTime now = LocalDateTime.now();
        return new UserDomain(id, cognitoId, fullname, email, now, now, wallets);
    }
    ...
    public static UserDomain from(UUID id, String cognitoId, String fullname, String email, LocalDateTime createdAt, LocalDateTime updatedAt, List<WalletDomain> wallets) {
        return new UserDomain(id, cognitoId, fullname, email, createdAt, updatedAt, wallets);
    }
