...
public class UserDomain {
    ...
    private UserDomain(UUID id, Name name, Email email, Password password, LocalDateTime createdAt, LocalDateTime updatedAt) {
    ...
    public static UserDomain create(UUID id, Name name, Email email, Password password) {
        LocalDateTime ahora = LocalDateTime.now();
        return new UserDomain(id, name, email, password, ahora, ahora);
    }

    public static UserDomain from(UUID id, Name name, Email email, Password password, LocalDateTime createdAt, LocalDateTime updatedAt) {
        return new UserDomain(id, name, email, password, createdAt, updatedAt);
    }
